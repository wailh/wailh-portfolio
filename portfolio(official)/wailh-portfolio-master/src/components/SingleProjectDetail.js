...
import '.././css-files/components/_signle-project-detail.css'
...
const SingleProjectDetail = ({ singleProject }) => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Djihad Hamdi | {singleProject.title}</title>
        <meta
          name="description"
          content="A project detail page to show Djihad Hamdi's web development project. It includes the summary of the individual project, tools used and design/development process."
        />
      </Helmet>
      <SimpleReactLightbox>
        {/* banner image */}
